  	...
  	var url = window.location.href;
    	...
    	return (			  
	        <div className="alert alert-danger alert-dismissible">
	            <p>Hubo un error al actualizar tu Red social, Verifica si los campos estan correctos <a href="" className="close" data-dismiss="alert" aria-label="close"> &times;</a>
	         </p>
	        </div>
		);  
    }
		...
		return (			  
	        <div className="alert alert-danger alert-dismissible">
	            <p>Hubo un error al crear tu Red social, Verifica si los campos estan correctos <a href="" className="close" data-dismiss="alert" aria-label="close"> &times;</a>
	         </p>
	        </div>
		); 
